  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className={cn('flex flex-col items-center justify-center', headingFont?.className)}>
        ...
        <h1 className="mb-6 text-center text-3xl text-neutral-800 md:text-6xl">Next-Board helps team move</h1>
        <div className="w-fit rounded-md bg-gradient-to-r from-purple-500 to-orange-500 p-2 px-4 pb-4 text-3xl text-white md:text-6xl">
          work forward.
        </div>
      </div>
      <div
      ...
      >
        ...
        team works is unique - accomplish it all with Next-Board.
      </div>
      <Button className="mt-6" size="lg" asChild>
        <Link href="/sign-up">Get Next-Board for free</Link>
      </Button>
    </div>
  )
}
